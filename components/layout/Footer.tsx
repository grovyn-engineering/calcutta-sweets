  ...
  return (
    <footer className="w-full bg-[#1a1208] text-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.45fr] gap-12 lg:gap-10">
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="font-dm-serif text-3xl sm:text-[32px] lg:text-[36px] tracking-wide leading-none">
                কলকত্তা SWEETS
              </h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <a
                  ...
                  className="block text-white/55 hover:text-white text-sm transition-colors duration-200 break-all"
                >
                  {CONTACT.email}
                </a>
