...
export default function OurStoryClient({ story, stats }: { story: any, stats: any[] }) {
  ...
  const secondPart = titleParts[1] ? `, ${titleParts.slice(1).join(",")}` : "";
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              `}
            >
              <span className="font-dm-serif text-lg sm:text-2xl lg:text-3xl text-[#FAF3E8] mb-1">
                {stat.value}
              </span>
              <span className="font-sans text-[8px] sm:text-[10px] uppercase tracking-[0.2em] font-medium text-[#C8773A]">
                {stat.label}
              </span>
            </motion.div>
          ))}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <h2 className="font-dm-serif text-4xl lg:text-5xl text-[#3D2B1F] leading-[1.2] mb-8">
              ...
              <span className="text-[#C8773A]">{secondPart}</span>
            </h2>
          ...
          <motion.div
            ...
            className="flex-1 relative w-full aspect-[4/3] lg:aspect-[5/4] max-w-sm sm:max-w-lg lg:max-w-2xl mx-auto"
          >
            <motion.div
              ...
              className="absolute -top-8 -left-8 lg:-top-12 lg:-left-12 z-20 w-16 h-16 sm:w-20 sm:h-20 lg:w-32 lg:h-32 rounded-full bg-[#C8773A] border-[6px] border-[var(--background)] shadow-xl flex flex-col items-center justify-center text-white"
            >
              <span className="font-sans text-[8px] sm:text-[9px] lg:text-[10px] uppercase tracking-widest font-medium opacity-90 mb-0.5">
                EST.
              </span>
              <span className="font-dm-serif text-base sm:text-lg lg:text-3xl">
                2000
              </span>
            </motion.div>
