...
const createOne = async (req, res) => {
  try {
    ...
    const item = await prisma.signatureSweet.create({
...
const updateOne = async (req, res) => {
  try {
    ...
    const existing = await prisma.signatureSweet.findUnique({ where: { id } });
    ...
    const updated = await prisma.signatureSweet.update({
      where: { id },
      data: {
...
const deleteOne = async (req, res) => {
  try {
    ...
    await prisma.signatureSweet.delete({ where: { id } });
